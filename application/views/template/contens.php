        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                ...
                <section id="intro">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                            ...
                            <p class="subline">I'm a college student who majors Informatics Engineer and just want to find what's best for me.</p>
                ...
                <section id="about">
                    ...
                    <p class="scroll-animated-from-right">I got a decent skill at photos and videos editing using Adobe Photoshop, Adobe Premiere Pro and Adobe After Effect as my main software to make it happen.</p>

                    <p class="scroll-animated-from-right">I have an experience at coding. I've made an app with Netbeans using java as my main language in making it. Also currently i'm trying to make a game using Unity.</p>
                ...
                <section id="service">
                    ...
                    <ul class="services-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Coding</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-eye" aria-hidden="true"></i>Design Graphics</li>
                ...
                <section id="work">
                    ...
                    <h3 class="headline scroll-animated-from-right">My latest Photo Shot.</h3>
                    ...
                    <div class="showcase">
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-1-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/foto-1.jpg)"></div>
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-2-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/foto-2.jpg)"></div>
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-3-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/foto-3.2.jpg)"></div>
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-4-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/foto-4.JPG)"></div>
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i>0812 - 1389 - 2343</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>fahriza668@gmail.com</li>
                ...
                <section id="footer">
                    ...
                    <p class="scroll-animated-from-right">© 2022 Asrama IT | Design by Fahriza Ramadhan <a href="https://asramait.blogspot.com/">Click Here!</a></p>
